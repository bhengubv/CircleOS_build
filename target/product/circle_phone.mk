# Circle OS - circle_phone product (one-codebase/every-device). GSI base + generic_arm64
...
PRODUCT_SYSTEM_PROPERTIES += ro.circle.formfactor=phone
PRODUCT_NAME    := circle_phone
PRODUCT_DEVICE  := generic_arm64
PRODUCT_BRAND   := Circle
PRODUCT_MODEL   := Circle OS (Phone)
