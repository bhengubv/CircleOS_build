# Circle OS - circle_tablet product (one-codebase/every-device). GSI base + generic_arm64
...
PRODUCT_SYSTEM_PROPERTIES += ro.circle.formfactor=tablet
PRODUCT_NAME    := circle_tablet
PRODUCT_DEVICE  := generic_arm64
PRODUCT_BRAND   := Circle
PRODUCT_MODEL   := Circle OS (Tablet)
